...
class Person extends \Faker\Provider\Person
{
    ...
    protected static $commonDutchLastNames = array(
        ...
        'van der Wal', 'Prins', 'Blom', 'Huisman', 'Peeters', 'de Jonge', 'Kuipers', 'van Veen', 'PostView', 'Kuiper',
    ...
    protected static $dutchLastNames = array(
        ...
        'PostView', 'Potters', 'van der Pouw', 'van Praagh', 'Pratt', 'Prinsen', 'Puig', 'Rackham', 'Rademaker', 'Ramaker',
